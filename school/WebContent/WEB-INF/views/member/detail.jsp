...
<div id="detail">
	...
	<div class="joinCenter row">
		...
		<div class="input_button text-center">
			<button id="mygradeButton" class="btn btn-primary">내 성적보기</button>
			<button id="updateButton" class="btn btn-primary">수정 폼으로 이동</button>
			<button id="deleteButton" class="btn btn-primary">회원탈퇴</button>
		</div>
	</div>
</div>
<script>
