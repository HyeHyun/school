...
<div class="container" style="width:1000px; margin:0 auto">
	...
	<div style="margin-top: 20px">
		...
		앨리먼트도 노드이고, 어트리뷰트도 노드이며 <br />
		앨리먼트 내부의 글 내용도 모두 노드이다. <br />
		앨리먼트를 요소 노드라고 칭하며, 어트리뷰트는 속성 노드 <br />
	...
	<div id="outBox">
		<h3>documentgetElementById() 의 예제</h3>
	...
	<div>
		<div>
			...
			<h3>document.createElementsByTagName() 의 예제</h3>
	...
	<div>
		<div>
			...
			<h3>document.createElementsByName() 의 예제</h3>
...
<script type="text/javascript">
	var dom = {
			...
			createTag2 : function() {
				var elem = document.createElement('div');
				elem.setAttribute('style', 'background: red; width: 500px; height: 100px; margin: 0 0 0 200px');
				document.body.appendChild(elem);
			},
			...
			selectElementsByName : function() {
				...
				for (var i = 2, elem; elem = elems[i]; i++) {
