...
//		RequestDispatcher dis = request.getRequestDispatcher(new Command(doProc(request, response)[0], doProc(request, response)[1]).getView());
		...
		RequestDispatcher dis = request.getRequestDispatcher(fac.getCommand(doProc(request, response)[0], doProc(request, response)[1]).getView());
	...
	protected String[] doProc(HttpServletRequest request, HttpServletResponse response) {
